        ...
        <div className="max-w-[1500px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <motion.div variants={itemVariants} className="flex gap-6 text-[var(--color-mysten-black)]">
              <a href="#" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
          ...
          <div className="flex flex-col justify-between">
            ...
            <motion.div variants={itemVariants} className="mt-16 flex flex-col sm:flex-row gap-4">
              ...
              />
              <button type="submit" className="bg-transparent border border-[var(--color-mysten-black)] text-[var(--color-mysten-black)] px-10 py-4 rounded-xl font-black uppercase tracking-wide hover:bg-[var(--color-mysten-black)] hover:text-[var(--color-mysten-white)] transition-colors shrink-0">
                Đăng ký
              </button>
            </motion.div>
          </div>
